...
const Header: React.FC = () => {
  ...
  return (
    <header className="flex justify-between items-center px-6 py-4 bg-white shadow-md rounded-full">
      <Link to="/" className="flex items-center gap-1">
        ...
        >
          <g clipPath="url(#clip0_1464_7948)">
            <path
        ...
        <span className="font-bold text-xl">Homely Haven</span>
      </Link>
      <div className="flex gap-2 border border-red-300 rounded-full py-3 px-4 shadow-md shadow-gray-300">
        <div>Anywhere</div>
      ...
      >
        ...
        {!!context?.user && <div>{context?.user.name.toUpperCase()}</div>}
      </Link>
    </header>
  );
};
